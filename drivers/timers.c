...
// Decrements the TimingDelays variables. Called by SysTick_Handler() in stm32f4xx_it.c
...
// Turns selected LED On for a given duration.
...
// Service routines called every CHECK_MSEC to debounce both edges
