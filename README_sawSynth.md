...
This project is a first attempt at building a portable battery-powered digital synthesiser using a STM32F407VG Discovery Board and a Korg NanoKontol 2 MIDI Controller. 

The project was coded using the dedicated synthesis programming language Faust[https://faust.grame.fr], with the aim being to enable synthesiser designs to be quickly prototyped in the browser, then uploaded to the board. The code for the whole project can be found [here](https://github.com/sidechained/Faust2STMSynth) and is a fork of the excellent (Dekrispator)[https://github.com/MrBlueXav/Dekrispator_v2] synthesiser project, using their drivers as a template. 

https://github.com/pierstitus/STM32F4-Synth

Please try it out and give your feedback online or on the back of this sheet.
